    ...
    public static class MilitaryJobTests
    {
        ...
        public static void DefaultEnabledJob_AllowedByDefault()
        {
            ...
            try
            {
                ...
                TestAssert.IsTrue(FindFC.PolicyManager.IsMilitaryJobAllowed(MilitaryJobDefOf.RaidEnemySettlement),
                    "Raid should be allowed by default (defaultEnabled=true)");
                TestAssert.IsTrue(FindFC.PolicyManager.IsMilitaryJobAllowed(MilitaryJobDefOf.CaptureEnemySettlement),
        ...
        public static void DefaultDisabledJob_BlockedByDefault()
        {
            ...
            {
                PolicyTestHelper.ClearAll(faction);
                TestAssert.IsFalse(FindFC.PolicyManager.IsMilitaryJobAllowed(MilitaryJobDefOf.EnslaveEnemySettlement),
        ...
        public static void EnabledMilitaryJob_OverridesDefault()
        {
            ...
            try
            {
                ...
                TestAssert.IsTrue(FindFC.PolicyManager.IsMilitaryJobAllowed(MilitaryJobDefOf.EnslaveEnemySettlement),
        ...
        public static void BlockedMilitaryJob_Blocks()
        {
            ...
            try
            {
                ...
                TestAssert.IsFalse(FindFC.PolicyManager.IsMilitaryJobAllowed(MilitaryJobDefOf.CaptureEnemySettlement),
        ...
        public static void Pacifist_BlocksActionNotJobs()
        {
            ...
            try
            {
                ...
                TestAssert.IsFalse(FindFC.PolicyManager.IsActionAllowed(FactionColonies.util.FCActionType.DeployMilitary),
        ...
        public static void Authoritarian_EnablesEnslave_JobLevel()
        {
            ...
            try
            {
                ...
                TestAssert.IsTrue(FindFC.PolicyManager.IsActionAllowed(FactionColonies.util.FCActionType.DeployMilitary),
